...
namespace playlist_lab.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(DBPlaylistContext context)
        {
            _context = context;
        }
       ...
       // public async Task<IActionResult> Create([Bind("Id,Age,Country,Fullname")] Artists artists)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
       // public async Task<IActionResult> Edit(int id, [Bind("Id,Age,Country,Fullname")] Artists artists)
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fullname,Country,Age")] Artists artists)
        {
            if (id != artists.Id)
            {
                return NotFound();
